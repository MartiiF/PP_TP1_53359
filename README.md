...
* `EventoUniversitario`: representa los eventos y sus actividades.
* `Sala`: representa las salas asignadas a los eventos.
* `Actividad`: clase abstracta para las actividades.
* `Charla`: actividad de tipo charla.
* `Taller`: actividad de tipo taller.
* `Inscripcion`: representa la inscripción de un estudiante a una actividad.
